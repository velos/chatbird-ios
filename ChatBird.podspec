...
Pod::Spec.new do |s|
  s.name             = 'ChatBird'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ChatBird.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/David Rajan/ChatBird'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'David Rajan' => 'david@velosmobile.com' }
  s.source           = { :git => 'https://github.com/David Rajan/ChatBird.git', :tag => s.version.to_s }
